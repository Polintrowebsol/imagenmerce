...
export const products: Product[] = [
  {
    ...
    original: originalAsset.url,
    generated: [
      { suffix: "_1", label: "Hero — front view", url: gen1.url },
      { suffix: "_2", label: "Angled view", url: gen2.url },
      { suffix: "_3", label: "Detail — material & edge", url: gen3.url },
      { suffix: "_4", label: "Lifestyle 01 — warm interior", url: gen4.url },
      { suffix: "_5", label: "Lifestyle 02 — minimal interior", url: gen5.url },
      { suffix: "_6", label: "Dimension drawing", url: gen6.url },
    ],
  },
];
