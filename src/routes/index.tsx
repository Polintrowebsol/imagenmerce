...
function CatalogScale() {
  ...
  return <section id="catalogs" className="section-pad page-shell"><SectionHead number="12" label="Built for catalogs & enterprise scale" title="Scale From One Product Launch To Massive Global Catalogs." copy="Traditional photoshoots are constrained by physical studio capacity and reshoot cycles. IMAGENMERCE is structured for high-volume catalog production, combining centralized production, repeatable visual rules and a four-point quality review so larger SKU sets can be processed without losing visual consistency."/><div className="mb-10 grid gap-4 border-y py-6 md:grid-cols-2"><p className="text-sm leading-7 text-muted-foreground">Our production system is designed to support 100+ image assets per day when project scope, references and approval flow are prepared for volume.</p><p className="text-sm leading-7"><strong>Scalability metric:</strong> Whether you supply 5 SKUs or plan a 500-product seasonal catalog, the same image rhythm, naming logic and review standards can be carried across the storefront.</p></div>
